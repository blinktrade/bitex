...
function $bitex$ui$Customers$$($opt_domHelper$$11$$) {
  $bitex$ui$DataGrid$$.call(this, {rowClassFn:this.$getRowClass$, columns:[{property:"Username", label:"Username", sortable:$JSCompiler_alias_FALSE$$, classes:function() {
  ...
  }}, {property:"Verified", label:"Verificado", sortable:$JSCompiler_alias_TRUE$$, formatter:function($s$$33$$) {
    return $s$$33$$ ? "Sim" : "N\u00e3o"
  }, classes:function() {
    return $bitex$ui$Customers$CSS_CLASS$$ + "-verified"
  }}, {property:"TwoFactorEnabled", label:"2 passos", sortable:$JSCompiler_alias_FALSE$$, formatter:function($s$$34$$) {
    return $s$$34$$ ? "Sim" : "N\u00e3o"
  }, classes:function() {
    ...
    return $goog$dom$createDom$$("button", {"class":"btn btn-mini btn-primary btn-deposit", "data-user-id":$row_set_obj$$4$$.ID}, "detalhes")
  }, classes:function() {
    return $bitex$ui$Customers$CSS_CLASS$$ + "-last-login"
  }}]}, $opt_domHelper$$11$$)
}
...
$goog$exportPath_$$("bitex.app.satoshi_square", function($url$$31$$) {
  ...
  var $withdraw_btc$$ = new $bitex$ui$Withdraw$$({$parent_id$:"withdraw_accordion", $button_label$:"Saque", title:"Sacar Bitcoin", description:"Fill up the form.", controls:[["amount", "Valor", "ex. 0.44550000", "\u0e3f"], ["wallet", "Wallet", "eg. 1933phfhK3ZgFQNLGSDXvqCn32k2buXY8a"]]}), $withdraw_brl_bank_transfer$$ = new $bitex$ui$Withdraw$$({$parent_id$:"withdraw_accordion", $button_label$:"Saque", title:"Sacar Reais em sua conta corrente", description:"R$ 10,00 fee for DOC and TED.", controls:[["amount", 
  "Valor", "ex. 2300", "R$"], ["bank_number", "Bank number", "eg. 341"], ["bank_name", "Bank name", "eg. Banco It\u00e1u"], ["account_branch", "Account Branch", "eg. 5555"], ["account_name", "Account name ", "eg. Jos\u00e9 da Silva"], ["account_number", "Account number", "ex. 888888"], ["CPFCNPJ", "CPF or CNPJ", "ex. 567.890.123-45"]]});
